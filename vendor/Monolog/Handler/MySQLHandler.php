<?php
# https://github.com/waza-ari/monolog-mysql/blob/master/src/MySQLHandler/MySQLHandler.php
...
class MySQLHandler extends AbstractProcessingHandler {
    ...
    private function initialize() {
        $this->pdo->exec(
            ...
            .'(channel VARCHAR(255), level INTEGER, message LONGTEXT, time INTEGER UNSIGNED, INDEX `level` (`level`))'
        );
